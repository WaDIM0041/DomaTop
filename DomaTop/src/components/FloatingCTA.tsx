    ...
    >
      ...
      <a
        ...
        style={{
          width: "60px",
          height: "60px",
          background: "linear-gradient(135deg, #c8a45a, #e0be82)",
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
          textDecoration: "none",
          boxShadow: "0 8px 32px rgba(200, 164, 90, 0.4)",
          position: "relative",
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "0",
            animation: "phoneRing 2s ease-out infinite 0.5s",
          }}
        />
        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#0a0a0a" strokeWidth="2.5">
